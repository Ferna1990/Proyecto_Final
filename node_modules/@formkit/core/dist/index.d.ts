 ...
 * @public
 */
export declare type ChildMessageBuffer = Map<string, Array<[FormKitMessage[], MessageClearer | undefined]>>;
 ...
 * @public
 */
export declare function createNode<V = unknown>(options?: FormKitOptions): FormKitNode<V>;
 ...
 * @internal
 */
export declare function createPlaceholder(options?: FormKitOptions & {
    name?: string;
 ...
 * @public
 */
export declare type ErrorMessages = string | string[] | Record<string, string | string[]>;
 ...
 * @internal
 */
export declare const FORMKIT_VERSION = "1.3.0-c4d1235";
 ...
 * @public
 */
export declare interface FormKitFrameworkContext<T = any> {
 ...
 * @public
 */
export declare interface FormKitInputMessages {
 ...
 * @public
 */
export declare type FormKitListContextValue<T = any> = Array<T>;
 ...
 * @public
 */
export declare type FormKitNode<V = unknown> = {
    /**
 ...
 * @public
 */
export declare interface FormKitNodeExtensions {
}
 ...
 * @public
 */
export declare interface FormKitPlaceholderNode<V = unknown> {
    /**
 ...
 * @public
 */
export declare type FormKitRootConfig = Partial<FormKitConfig> & {
 ...
 * @public
 */
export declare type FormKitSchemaDefinition = FormKitSchemaNode | FormKitSchemaNode[] | FormKitSchemaCondition;
 ...
 * @public
 */
export declare type FormKitSchemaMeta = {
 ...
 * @public
 */
export declare interface FormKitStoreTraps {
 ...
 * @public
 */
export declare function isPlaceholder(node: FormKitNode | FormKitPlaceholderNode): node is FormKitPlaceholderNode;
 ...
 * @public
 */
export declare type MessageClearer = string | ((message: FormKitMessage) => boolean);
